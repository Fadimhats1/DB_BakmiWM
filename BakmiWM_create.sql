...
CREATE TABLE SouvenirTransaction(
	...
	StaffID CHAR(5) FOREIGN KEY (StaffID) REFERENCES staff(StaffID) ON UPDATE CASCADE ON DELETE SET NULL,
	CustomerID CHAR(5) FOREIGN KEY (CustomerID) REFERENCES Customer(CustomerID) ON UPDATE CASCADE ON DELETE SET NULL,
